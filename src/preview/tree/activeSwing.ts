...
import { DevSwingDirectoryNode, DevSwingFileNode } from "./nodes";
  ...
  return files
    ...
    .map(([file, fileType]) => {
      ...
      return fileType === FileType.Directory
        ? new DevSwingDirectoryNode(swingUri, filePath)
        : new DevSwingFileNode(swingUri, filePath);
    });
}
...
class ActiveSwingTreeProvider
  ...
  getChildren(element?: TreeItem): ProviderResult<TreeItem[]> {
    ...
    } else if (element instanceof DevSwingDirectoryNode) {
