...
const templateProviders = new Map<
  string,
  [DevSwingTemplateProvider, DevSwingTemplateProviderOptions]
>();
export function registerTemplateProvider(
  providerName: string,
  provider: DevSwingTemplateProvider,
  options: DevSwingTemplateProviderOptions
) {
